...
// #define STACK_DEBUG
        ...
        case Pyc::CHECK_EXC_MATCH:
            {
                ...
                check_exc_match = true;
            }
            break;
        case 210: // RERAISE (3, 11)
            {
                auto arg = operand;
                if (arg == 1) {
        ...
        case Pyc::BUILD_TUPLE_A:
            {
                ...
                // long long operand_ = 0;
                // if (operand > 100) {
                //     operand_ = operand - 100;
                //     operand = 100;
                // }
                for (int i=0; i<operand; i++) {
        ...
        case Pyc::INSTRUMENTED_POP_JUMP_IF_TRUE_A:
            {
                ...
                if ((cond.type() == ASTNode::NODE_COMPARE
                        && cond.cast<ASTCompare>()->op() == ASTCompare::CMP_EXCEPTION) || (check_exc_match)) {
        ...
        case Pyc::INSTRUMENTED_JUMP_FORWARD_A:
            {
                ...
                do {
                    ...
                    if(opcode == Pyc::JUMP_FORWARD_A) {
                        fprintf(stderr, "if JUMP_FORWARD_A\n" );
                        break;
                    }
        ...
        case Pyc::GEN_START_A:
            ...
            break;
        default:
            fprintf(stderr, "Unsupported opcode: %s (%d - %d)\n", Pyc::OpcodeName(opcode & 0xFF), opcode, pos);
            cleanBuild = false;
